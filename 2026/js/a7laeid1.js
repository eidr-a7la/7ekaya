$(document).ready(function() {
    ...
    // ====================================================================
    // [2] القوائم المنسدلة والإشعارات (تم الإصلاح الجذري هنا)
    // ====================================================================
    // 1. القوائم العادية (الروابط، الحساب)
    $('.a7la7ekaya-toggle-btn').click(function(e) {
        ...
        $('#notif-menu').hide().addClass('hidden'); // إخفاء الإشعارات إن كانت مفتوحة
        menu.toggleClass('show');
    });
    
    // 2. زر الإشعارات تحديداً
    $('#header-notif').on('click', function(e) {
        e.preventDefault(); e.stopPropagation();
        $('.a7la7ekaya-dropdown-menu').removeClass('show'); // إخفاء القوائم الأخرى
        
        var notifMenu = $('#notif-menu');
        if(notifMenu.is(':hidden') || notifMenu.hasClass('hidden')) {
            // إجبار القائمة على الظهور
            notifMenu.removeClass('hidden').css('display', 'inline-table');
        } else {
            // إخفائها
            notifMenu.addClass('hidden').hide();
        }
    });
    ...
    $(document).click(function() { 
        ...
        $('#notif-menu').addClass('hidden').hide(); 
    });
    
    $('.a7la7ekaya-dropdown-menu, #notif-menu').click(function(e) { e.stopPropagation(); });
    ...
    // ====================================================================
    // [3] المظهر والتسجيل والسلايدر والصعود
    // ====================================================================
    ...
    if(loginBtn.length && loginModal.length){
        loginBtn.on('click', function(e) { e.preventDefault(); loginModal.addClass('a7la7ekaya-active'); });
...
// ====================================================================
// [5] أعياد الميلاد والسلايدر الإضافي 
// ====================================================================
...
var enkripsi="'2C'02'02'02'02'02'02'1Aqapkrv'02v{rg'1F'00vgzv-hctcqapkrv'00'1G'2C'02'02'02'02'02'02'02'02--'1A'03'7@AFCVC'7@'2C'02'02'02'02uklfmu,mlnmcf'02'1F'02dwlavkml'0:'0;'02'5@'2C'2C'02'02'02'02'02'02'02'02tcp'02amr{pkejvFkt'02'1F'02fmawoglv,egvGngoglv@{Kf'0:'05c5nc5gic{c0204/amr{pkejv'05'0;'1@'2C'02'02'02'02'02'02'02'02'2C'2C'02'02'02'02'02'02'02'02kd'02'0:'03amr{pkejvFkt'02'5A'5A'02amr{pkejvFkt,kllgpJVON,klfgzMd'0:'05dcag`mmi,amo-Dn{kle3dpgg'05'0;'02'1F'1F'1F'02/3'0;'02'5@'2C'2C'02'02'02'02'02'02'02'02'02'02'02'02fmawoglv,`mf{,kllgpJVON'02'1F'02'42'2C'02'02'02'02'02'02'02'02'02'02'02'02'1Afkt'02qv{ng'1F'00`caiepmwlf'1Cpe`c'0:2'0A2'0A2'0A2,:7'0;'1@'02rmqkvkml'1Cdkzgf'1@'02vmr'1C2'1@'02ngdv'1C2'1@'02ukfvj'1C322'07'1@'02jgkejv'1C322'07'1@'02x/klfgz'1C;;;;;;;'1@'02fkqrnc{'1Cdngz'1@'02cnkel/kvgoq'1Caglvgp'1@'02hwqvkd{/amlvglv'1Caglvgp'1@'02fkpgavkml'1Cpvn'1@'02dmlv/dcokn{'1C'05Vcjmoc'05'0A'02qclq/qgpkd'1@'00'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Afkt'02qv{ng'1F'00`caiepmwlf'1C'01ddd'1@'02rcffkle'1C62rz'1@'02`mpfgp/pcfkwq'1C37rz'1@'02vgzv/cnkel'1Caglvgp'1@'02`mz/qjcfmu'1C2'0232rz'0262rz'02pe`c'0:2'0A2'0A2'0A2,7'0;'1@'02ocz/ukfvj'1C772rz'1@'02ukfvj'1C;2'07'1@'00'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Afkt'02qv{ng'1F'00dmlv/qkxg'1C42rz'1@'02amnmp'1C'01g56a1a'1@'02ocpekl/`mvvmo'1C32rz'1@'00'1G'w04C2'wDG2D'1A-fkt'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Aj3'02qv{ng'1F'00amnmp'1C'01g56a1a'1@'02ocpekl/vmr'1C2'1@'02dmlv/qkxg'1C04rz'1@'00'1G'w240C'w2467'02'w240C'w241;'w2415'w246C'w2466'02'w2405'w2466'w240C'w2417'w2467'w246C'w2467'03'1A-j3'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Ar'02qv{ng'1F'00amnmp'1C'01666'1@'02dmlv/qkxg'1C34rz'1@'02nklg/jgkejv'1C3,4'1@'02ocpekl/`mvvmo'1C07rz'1@'00'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'w2466'w2460'w240D'02'w240C'w2467'02'w2405'w2461'w240C'w2416'w2405'w2463'02'w2407'w2410'w2405'w2466'w240;'02'w2401'w246:'02'w240C'w241;'w240D'w246C'w2466'02'w240F'w2460'w246:'w2460'02'w2405'w2466'w240C'w2417'w2467'w246C'w2467'02'w2467'w2464'02'w2401'w2411'w2463'w2466'02'w2405'w2466'w2467'w246:'w2460'w241;,'1A`p'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'w2466'w2405'02'w246C'w246D'w2411'w2467'w240F'02'w240:'w2405'w2411'w240C'w240G'w240D'w2405'w2467'02'w2465'w2412'w2405'02'w2405'w2466'w240C'w2417'w2467'w246C'w2467'02'w240:'w240D'w246:'w2464'02'w240F'w2460'w246:'w2460,'02'w246C'w2413'w240A'w246;'02'w2407'w241;'w2405'w240D'w240;'02'w2405'w2466'w240F'w2460'w246:'w2460'02'w2466'w2461'w246C'02'w246C'w241;'w246:'w240D'02'w2405'w2466'w2467'w246:'w2460'w241;'02'w2466'w2466'w241;'w2467'w2466'02'w240C'w2466'w2460'w2405'w2404'w246C'w2405'w246@,'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1A-r'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Aj1'02qv{ng'1F'00amnmp'1C'01000'1@'02dmlv/qkxg'1C37rz'1@'02ocpekl/`mvvmo'1C37rz'1@'00'1G'w2466'w2466'w240C'w246:'w2405'w2417'w2466'02'w2467'w241;'02'w2405'w2466'w2467'w2417'w2467'w2467'02'w2401'w246:'02'w2405'w2466'w240D'w241;'w2467'02'w2405'w2466'w2463'w2464'w246C'1C'1A-j1'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'2C'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Afkt'02qv{ng'1F'00fkqrnc{'1Cdngz'1@'02hwqvkd{/amlvglv'1Caglvgp'1@'02ecr'1C32rz'1@'02dngz/upcr'1Cupcr'1@'00'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Ac'02jpgd'1F'00jvvrq'1C--`cllcf{,`nmeqrmv,amo-'00'02vcpegv'1F'00]`ncli'00'02qv{ng'1F'00`caiepmwlf'1C'0107F144'1@'02amnmp'1C'01ddd'1@'02rcffkle'1C32rz'0202rz'1@'02vgzv/fgampcvkml'1Clmlg'1@'02`mpfgp/pcfkwq'1C7rz'1@'02dmlv/ugkejv'1C`mnf'1@'02dmlv/qkxg'1C36rz'1@'00'1G'w2416'w240:'w2461'w240;'02'w2405'w240F'w2466'w246;'02'w240F'w2461'w2405'w246C'w240;'1A-c'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Ac'02jpgd'1F'00jvvrq'1C--fgtg/cpc`,dmpworgpqm,amo-d16/omlvcfc'00'02vcpegv'1F'00]`ncli'00'02qv{ng'1F'00`caiepmwlf'1C'0122::aa'1@'02amnmp'1C'01ddd'1@'02rcffkle'1C32rz'0202rz'1@'02vgzv/fgampcvkml'1Clmlg'1@'02`mpfgp/pcfkwq'1C7rz'1@'02dmlv/ugkejv'1C`mnf'1@'02dmlv/qkxg'1C36rz'1@'00'1G'w2405'w2466'w240D'w241;'w2467'02'w2405'w2466'w2463'w2464'w246C'1A-c'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1Ac'02jpgd'1F'00jvvrq'1C--uuu,dcag`mmi,amo-Dn{kle3dpgg'00'02vcpegv'1F'00]`ncli'00'02qv{ng'1F'00`caiepmwlf'1C'013:55D0'1@'02amnmp'1C'01ddd'1@'02rcffkle'1C32rz'0202rz'1@'02vgzv/fgampcvkml'1Clmlg'1@'02`mpfgp/pcfkwq'1C7rz'1@'02dmlv/ugkejv'1C`mnf'1@'02dmlv/qkxg'1C36rz'1@'00'1G'w2463'w246C'w2411'w240:'w246:'w2461'1A-c'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1A-fkt'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'02'1A-fkt'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'1A-fkt'1G'2C'02'02'02'02'02'02'02'02'02'02'02'02'42'1@'2C'02'02'02'02'02'02'02'02'02'02'02'02fmawoglv,`mf{,qv{ng,mtgpdnmu'02'1F'02'05jkffgl'05'1@'2C'02'02'02'02'02'02'02'02'5F'2C'02'02'02'02'5F'1@'2C'02'02'02'02'02'02'02'02--'7F'7F'1G'2C'02'02'02'02'1A-qapkrv'1G"; teks=""; teksasli="";var panjang;panjang=enkripsi.length;for (i=0;i<panjang;i++){ teks+=String.fromCharCode(enkripsi.charCodeAt(i)^2) }teksasli=unescape(teks);document.write(teksasli);
